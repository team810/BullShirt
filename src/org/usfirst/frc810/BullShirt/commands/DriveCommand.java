...
import org.usfirst.frc810.BullShirt.*;
...
public class DriveCommand extends Command {
	...
	private double m_sideMultiplier;
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=VARIABLE_DECLARATIONS
	
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public DriveCommand(double m_speedMultiplier, double m_sideMultiplier) {

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=VARIABLE_SETTING
    	this.m_speedMultiplier = m_speedMultiplier;
    	this.m_sideMultiplier = m_sideMultiplier;
    ...
    protected void execute() {
    	...
    	Robot.drive.arcadeDrive(sideStick * this.m_sideMultiplier,forStick * this.m_speedMultiplier);
    }
